      ...
      <main className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-6">Tentang JokiGoC</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Platform terpercaya untuk jasa joki tugas dan template berkualitas tinggi
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-xl p-8 border border-dark-700">
              ...
              <p className="text-gray-300 leading-relaxed">
                Memberikan solusi cepat dan berkualitas untuk kebutuhan akademis dan bisnis, 
                membantu pelajar, mahasiswa, dan profesional mencapai tujuan mereka dengan 
                efisien dan hasil yang memuaskan.
              </p>
            </div>
            ...
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-xl p-8 border border-dark-700">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                serta berkontribusi pada kemajuan pendidikan dan bisnis di Indonesia.
              </p>
            </div>
          </div>
          ...
          {/* Values */}
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-white text-center mb-12">Nilai-Nilai Kami</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-dark-800/50 backdrop-blur-sm rounded-xl p-6 border border-dark-700 text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Menjaga kepercayaan pelanggan dengan hasil berkualitas dan kerahasiaan data
                </p>
              </div>
